...
function GM:LoadAmmo()
	self:RegisterAmmo(includes.CurrentFolder(1) .. "classes/ammo/ammo_base.lua")
	self:RegisterAmmo(includes.CurrentFolder(1) .. "classes/ammo/ammo_ballistic.lua")
	self:RegisterAmmo(includes.CurrentFolder(1) .. "classes/ammo/ammo_beanbag.lua")

	self:RegisterAmmoFolder("classes/ammo/ballistic")
end
